...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a href="index.html"><img class="navbar-brand" src="paypallogo.png" id="logopypl"></img></a>
    ...
    <!-- Banner principal -->
    <div class="jumbotron">
        <h1 class="display-4">Bem-vindo à <span id="paypal">PayPal!</span></h1>
        <p class="lead">Essa é uma sessão sandbox feita pelo Wesley Gomes para testar os produtos e as APIs disponíveis da PayPal.</p>
        <hr class="my-4">
        <p>Caso você deseje saber mais sobre a PayPal, clique no link abaixo!</p>
        <a class="btn btn-outline-info btn-lg" href="https://developer.paypal.com/" role="button">Saber mais</a>
    </div>

    <!-- <p class="animated bounce delay-0.8 s">&nbsp&nbsp&nbsp&nbsp Apenas um teste</p> -->
